...
while True:
    ...
    numberp = random.randint(1, 999999999)
    numbero = random.randint(1, 300)
    numbert = random.randint(1, 100)
    ...
    # 姓氏列表
    surnames = ['张', '王', '李', '赵', '刘', '陈', '杨', '黄', '周', '吴', '严', '赵', '韩', '杰', '车', '浩', '吉',
                '林', '龙', '东', '杭','房','模','零','其','欧','坡','全','的','迟','颇','卡']
    # 名字列表
    names = ['伟', '敏', '婷', '克', '宇', '静', '磊', '娜', '杰', '丽', '娟', '卷', '明', '格', '星', '鱼', '广', '肉',
             '动','都','电','如','并','哇','人','哦','撒','事','咯','体']
    namd=['丽', '娟', '卷', '明', '格', '星', '鱼', '广', '肉',
             '动','都','电','如','并','哇','人','哦','撒','事','咯','体']
    ...
    # 定义一些常见的医院名称元素
    city_names = ["北京", "上海", "广州", "深圳", "西安", "南京", "武汉", "成都", "杭州", "重庆",'香港','台湾','海南','山东']
    hospital_types = ["人民医院", "中医院", "儿童医院", "妇幼保健院", "骨科医院", "肿瘤医院", "康复医院", "第三医院",
                      "第二医院", "大学附属医院"]
    prefixes = ["市", "省", "综合"]
